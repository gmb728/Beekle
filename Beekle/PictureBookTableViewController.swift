...
class PictureBookTableViewController: UITableViewController {
    ...
    var books = ["Papa Please Get the Moon for Me", "We are Going on a Bear Hunt","What's the Time, Mr. Wolf?","Eat Your Peas", "Handa's Surprise","Guess How Much I Love You","Bark, George", "We All Go Traveling By","Silly Sally", "Santa's Beard", "Beekle"]
